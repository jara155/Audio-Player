      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
              color: Music.isPlaying(music)
                  ? Colors.green
                  : Barvy.getColorFromTheme("secondary"),
              border: homeKey.currentState!.favoriteMusics.contains(music) &&
                      homeKey.currentState!.selected != "favorite"
